function open_time(kjdata) {
    fg1 = GameType.split("_");
    if (count(fg1) != 2) { return; }
	
    if (fg1[0] == "CQSSC") {

        var actionNo = Number(kjdata.substr(-3)) + 0;
        ...
        var qishu = ((Number(kjdata) - 630226) % 179) + 1;

        console.log(kjdata);
        console.log(qishu);
        var d = conf[qishu - 1].split(':');
        ...
        _date.setSeconds(0);
        _date.setHours(d[0]);
        _date.setMinutes(d[1]);

        var diffTime = _date.getTime() - time;
        ...
        //江苏快3   每天82期、每10分钟1期；每天早上8点30分至晚上10点10分；  20180526082|134
        var actionNo = Number(kjdata.substr(-2));
        ...
        //安徽快3   每天80期、每10分钟1期；每天早上8点50分至晚上10点00分；  20180526080|245
        var actionNo = Number(kjdata.substr(-2)) + 0;
        ...
        //湖北快3   每天78期、每10分钟1期；每天早上9点00分至晚上10点00分；  20180526078|235
        var actionNo = Number(kjdata.substr(-2)) + 0;//1385
        if (actionNo > 78) actionNo = 1;
        ...
        var qishu = ((Number(kjdata) - 110433) % 89 + 0);
        var d = conf[qishu - 1].split(':'); //取出第1385个
        var date = new Date();
        var time = date.getTime();
        var delay = 60000;
        date.setSeconds(0);
        ...
        //河北快3   每天81期、每10分钟1期；每天早上8点30分至晚上9点55分；   20180526081|234
        var actionNo = Number(kjdata.substr(-2)) + 0;//1385
        if (actionNo > 81) actionNo = 1;
		
        var conf = ["08:40", "08:50", "09:00", "09:10", "09:20", "09:30", "09:40", "09:50", "10:00", "10:10", "10:20", "10:30", "10:40", "10:50", "11:00", "11:10", "11:20", "11:30", "11:40", "11:50", "12:00", "12:10", "12:20", "12:30", "12:40", "12:50", "13:00", "13:10", "13:20", "13:30", "13:40", "13:50", "14:00", "14:10", "14:20", "14:30", "14:40", "14:50", "15:00", "15:10", "15:20", "15:30", "15:40", "15:50", "16:00", "16:10", "16:20", "16:30", "16:40", "16:50", "17:00", "17:10", "17:20", "17:30", "17:40", "17:50", "18:00", "18:10", "18:20", "18:30", "18:40", "18:50", "19:00", "19:10", "19:20", "19:30", "19:40", "19:50", "20:00", "20:10", "20:20", "20:30", "20:40", "20:50", "21:00", "21:10", "21:20", "21:30", "21:40", "21:50", "22:00", "22:10"];

        var d = conf[actionNo - 1].split(':'); //取出第1385个
        var date = new Date();
        var time = date.getTime();
        var delay = 60000;
        date.setSeconds(0);
        ...
        //甘肃快3   每天72期、每10分钟1期；每天早上9点50分至晚上9点50分；   20180526072|225
        var actionNo = Number(kjdata.substr(-2)) + 0;//1385	
        if (actionNo > 72) actionNo = 1;
        ...
        //上海快3   每天82期、每10分钟1期；每天早上8点40分至晚上10点20分；  20180526082|126
        var actionNo = Number(kjdata.substr(-2)) + 0;//1385
        if (actionNo > 82) actionNo = 1;
        ...
        //贵州快3   每天78期、每10分钟1期；每天早上9点00分至晚上10点00分；  20180526078|125
        var actionNo = Number(kjdata.substr(-2)) + 0;//1385
        if (actionNo > 78) actionNo = 1;

        var conf = ["09:20", "09:30", "09:40", "09:50", "10:00", "10:10", "10:20", "10:30", "10:40", "10:50", "11:00", "11:10", "11:20", "11:30", "11:40", "11:50", "12:00", "12:10", "12:20", "12:30", "12:40", "12:50", "13:00", "13:10", "13:20", "13:30", "13:40", "13:50", "14:00", "14:10", "14:20", "14:30", "14:40", "14:50", "15:00", "15:10", "15:20", "15:30", "15:40", "15:50", "16:00", "16:10", "16:20", "16:30", "16:40", "16:50", "17:00", "17:10", "17:20", "17:30", "17:40", "17:50", "18:00", "18:10", "18:20", "18:30", "18:40", "18:50", "19:00", "19:10", "19:20", "19:30", "19:40", "19:50", "20:00", "20:10", "20:20", "20:30", "20:40", "20:50", "21:00", "21:10", "21:20", "21:30", "21:40", "21:50", "22:00", "22:10"];
        ...
        //吉林快3   每天87期、每10分钟1期；每天早上8点20分至晚上09点40分；  20180526087|355
        var actionNo = Number(kjdata.substr(-2)) + 0;//1385
        if (actionNo > 87) actionNo = 1;

        var conf = ["08:20", "08:30", "08:40", "08:50", "09:00", "09:10", "09:20", "09:30", "09:40", "09:50", "10:00", "10:10", "10:20", "10:30", "10:40", "10:50", "11:00", "11:10", "11:20", "11:30", "11:40", "11:50", "12:00", "12:10", "12:20", "12:30", "12:40", "12:50", "13:00", "13:10", "13:20", "13:30", "13:40", "13:50", "14:00", "14:10", "14:20", "14:30", "14:40", "14:50", "15:00", "15:10", "15:20", "15:30", "15:40", "15:50", "16:00", "16:10", "16:20", "16:30", "16:40", "16:50", "17:00", "17:10", "17:20", "17:30", "17:40", "17:50", "18:00", "18:10", "18:20", "18:30", "18:40", "18:50", "19:00", "19:10", "19:20", "19:30", "19:40", "19:50", "20:00", "20:10", "20:20", "20:30", "20:40", "20:50", "21:00", "21:10", "21:20", "21:30", "21:40", "21:50", "22:00", "22:10"];
